...
export function LabsPage() {
  const LAB_CATEGORIES = [
    { title: 'ATAL TINKERING LAB (ATL)', icon: Lightbulb, desc: 'Nurturing curiosity and creativity through hands-on learning' },
    { title: 'AICTE IDEA LAB', icon: Brain, desc: 'Inspire, Ideate and Innovate with advanced maker space' },
    { title: 'NAIN PROJECT LAB', icon: HardHat, desc: 'Project based learning with industry relevant exposure' },
    { title: 'INNOVATION ROBOTICS LAB', icon: Bot, desc: 'Explore Robotics, Automation & Real world applications' },
    { title: 'STEM EDUCATION LAB', icon: Atom, desc: 'Integrated Learning of Science, Technology, Engineering & Mathematics' },
    { title: 'IOT & AI LAB', icon: Cpu, desc: 'Work with IoT Devices AI tools & smart solutions' },
    { title: 'EMBEDDED SYSTEMS LAB', icon: Workflow, desc: 'Design, develop & deploy embedded solutions' }
  ];
    ...
    <div className="bg-[#fbfbfb] min-h-screen flex flex-col">
      <div className="bg-white border-b border-gray-100 py-20 flex-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-[#1d1d1f] tracking-tight text-center">Institutional Lab Setups</h1>
          <p className="text-lg text-gray-500 max-w-2xl text-center mb-8">
            TECHNOLOGY LAB SETUPS - BUILD, INNOVATE & LEARN
          </p>
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 text-[#1d1d1f]">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {LAB_CATEGORIES.map((lab, i) => (
