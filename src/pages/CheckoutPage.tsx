    ...
    <div className="bg-[#fbfbfb] min-h-screen pt-24 pb-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <Link
            to="/store"
            className="inline-flex items-center text-sm font-medium text-gray-500 hover:text-[#1d1d1f] transition-colors mb-4"
          >
        ...
        {cart.length === 0 ? (
          <div className="bg-white p-12 rounded-3xl border border-gray-100 shadow-sm text-center">
            ...
            <Link
              to="/store"
              className="inline-flex items-center justify-center bg-blue-600 text-white px-8 py-3 rounded-full font-bold hover:bg-blue-700 transition-colors"
            >
              Continue Shopping
            </Link>
          </div>
          ...
          <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                {cart.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 border border-gray-200 rounded-full px-2 py-1 bg-[#fbfbfb] self-start sm:self-auto">
                      ...
                      <span className="w-6 text-center font-bold text-[#1d1d1f]">
                        {item.quantity}
                      </span>
                      <button
                        onClick={() =>
            ...
            <div className="bg-[#fbfbfb] p-6 sm:p-8 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="text-center sm:text-left">
                ...
                <p className="text-[#1d1d1f] font-bold text-xl">
