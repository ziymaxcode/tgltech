        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="mb-8">
              <h2 className="font-bold text-2xl text-[#1d1d1f] mb-4 tracking-tight">
                About Project
              </h2>
              ...
              <p className="text-gray-500 text-lg leading-relaxed">
                {project.abstract || project.synopsis}
              </p>
            </section>
                    ...
                    {componentsNeeded.map((p: any) => (
                      <li key={p.id}>
                        ...
                        >
                          ...
                          <div className="ml-3">
                            <p className="text-sm font-bold text-[#1d1d1f] group-hover:text-blue-600 line-clamp-1">
                              {p.name}
                            </p>
                          </div>
                        </Link>
              ...
              <div className="bg-[#fbfbfb] p-6 rounded-3xl border border-gray-100">
                ...
                {relatedCourses.map((c: any) => (
                  <Link
                    ...
                    className="block bg-white p-4 rounded-2xl shadow-sm border border-gray-100 hover:border-blue-200 transition-colors"
                  >
                    <h4 className="font-bold text-[13px] text-[#1d1d1f] mb-1">
                      {c.name}
                    </h4>
